...
$WGET 'adf-core.jar' "https://github.com/RCRS-ADF/core/raw/jar/build/libs/adf-core.jar?$$"
# $WGET 'adf-modules.jar' "https://raw.githubusercontent.com/RCRS-ADF/modules/master/build/libs/adf-modules.jar?$$"
cd sources
$WGET 'adf-core-sources.jar' "https://github.com/RCRS-ADF/core/raw/jar/build/libs/adf-core-sources.jar?$$"
