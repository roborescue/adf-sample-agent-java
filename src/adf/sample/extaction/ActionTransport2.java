...
public class ActionTransport2 extends ExtAction {

    private Human target;

    public ActionTransport2(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DebugData debugData) {
