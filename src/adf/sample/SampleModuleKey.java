...
public class SampleModuleKey {
    ...
    public static final String AMBULANCE_MODULE_TASK_HUMAN_SELECTOR = "TacticsAmbulance.TaskHumanSelector";
    public static final String AMBULANCE_MODULE_TASK_SEARCH = "TacticsAmbulance.TaskSearch";
    ...
    public static final String FIRE_MODULE_TASK_BUILDING_SELECTOR = "TacticsFire.TaskBuildingSelector";
    public static final String FIRE_MODULE_TASK_SEARCH = "TacticsFire.TaskSearch";
    ...
    public static final String POLICE_MODULE_TASK_SEARCH = "TacticsPolice.TaskSearch";
